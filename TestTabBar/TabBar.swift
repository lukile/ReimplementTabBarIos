...
public class TabBar : UIView {
    ...
    private var buttonMore: UIButton = UIButton()
    ...
    public func selectNumberOfButton(numberButton: Int) -> [UIButton] {
        ...
        let newButtons = self.addButtonToTabBar(sizeTabBar: screensizeWidth)
        return newButtons
    }
       ...
       // var position = Position.self
        ...
        if position == .BOTTOM || position == .TOP {
            for i in 0..<buttons.count {
                if(i == 0) {
                    buttons[i].frame.origin.x = 0
                } else {
                    buttons[i].frame.origin.x = buttons[i - 1].frame.origin.x + 110
                }
    ...
    private func addButtonToTabBar(sizeTabBar: CGFloat) -> [UIButton] {
        ...
        for _ in 0..<self.buttons.count {
            ...
            //print("sizeButton: \(sizeButton), sizeTabBar : \(sizeTabBar)")
    ...
    private func setButtonSize(buttonWidth: CGFloat) -> CGFloat {
        let screensizeWidth = UIScreen.main.bounds.width
        print(screensizeWidth * buttonWidth)
        return screensizeWidth * buttonWidth
    }
